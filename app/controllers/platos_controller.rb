class PlatosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @plato.save
        format.html { redirect_to @plato, notice: 'Plato fue creado exitosamente.' }
  ...
  def update
    respond_to do |format|
      if @plato.update(plato_params)
        format.html { redirect_to @plato, notice: 'Plato fue editado exitosamente.' }
  ...
  def destroy
    @plato.destroy
    respond_to do |format|
      format.html { redirect_to platos_url, notice: 'Plato fue eliminado exitosamente.' }
  ...
  private
    ...
    def plato_params
      params.require(:plato).permit(:nombre, :costo, :disponible)
    end
end
